          ...
          <form>
            <Box sx={{ display: 'flex', gap: '20px', margin: '10px' }}>
              ...
              <TextField
                ...
                onChange={(e) =>
                  setFormData({ ...formData, optionForfait: e.target.value })
                }
              />
            </Box>
            <Box sx={{ display: 'flex', gap: '20px', margin: '10px' }}>
              <TextField
                ...
                onChange={(e) =>
                  setFormData({ ...formData, soldeData: e.target.value })
                }
              />
              <TextField
                label="Solde appel"
                ...
                onChange={(e) =>
                  setFormData({ ...formData, soldeAppels: e.target.value })
                }
              />
            </Box>
            <Box sx={{ display: 'flex', gap: '20px', margin: '10px' }}>
              <TextField
                ...
                onChange={(e) =>
                  setFormData({ ...formData, rfForfait: e.target.value })
                }
              >
